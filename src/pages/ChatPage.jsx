                ...
                >
                    ...
                    {messages.map((message, index) => (
                        ...
                        >
                            ...
                            <div
                                className={`flex items-end ${message.sentByCurrentUser ? "justify-end" : "justify-start"
                                    }`}
                            >
                                <div
                                    className={`flex flex-col space-y-2 text-xs max-w-xs mx-2 ${message.sentByCurrentUser ? "order-2" : "order-1"
                                        } items-start`}
                                >
                                    {message.type === "text" && (
                                        <div>
